import { ArrowLeft, Zap, Scale } from "lucide-react@0.487.0";
...
export function MentionsLegalesPage({ onBack }: MentionsLegalesPageProps) {
  return (
        ...
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-2xl shadow-lg border border-border/50 p-8 md:p-12">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <p className="text-lg text-muted-foreground">
              CachetFlow est une application web destinée aux intermittents du spectacle pour la gestion de leurs cachets, 
              dépenses et revenus. Les informations légales complètes concernant l'éditeur, l'hébergeur et les conditions 
              d'utilisation seront publiées prochainement.
            </p>
